...
public class AnuncioController {
  ...
  @ApiOperation(value = "Retorna todas os anúncios cadastrados no sistema.", response = Anuncio.class, responseContainer = "List", produces = json)
  @GetMapping
  ...
  public ResponseEntity<?> getAnuncios(){
    ...
    @ApiOperation(value = "Cria um novo anúncio", response = Anuncio.class, produces = json, consumes = json)
  @PostMapping
  ...
  @ApiOperation(value = "Busca anúncio específico pelo código", response = Anuncio.class, produces = json)
	@GetMapping("/{codigo}")
  ...
  @ApiOperation(value = "Deleta anúncio específico pelo código")
  ...
  public void deletaPeloCodigo(@PathVariable Long codigo){
    ...
    @ApiOperation(value = "Atualiza os dados de um anúncio", response = Anuncio.class, produces = json)
  @PutMapping("/{codigo}")
